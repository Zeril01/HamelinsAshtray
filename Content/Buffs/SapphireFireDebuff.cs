...
namespace HamelinsAshtray.Content.Buffs
{
    public class SapphireFireDebuff : ModBuff
    {
        ...
        internal static void DrawEffects(NPC npc)
        {
            ...
            {
                Dust dust = Dust.NewDustDirect(npc.position - new Microsoft.Xna.Framework.Vector2(2f, 2f), npc.width + 4, npc.height + 4, DustID.BlueTorch, npc.velocity.X * 0.4f, npc.velocity.Y * 0.4f, 100, default, 3.5f);
                dust.noGravity = true;
                dust.velocity *= 1.8f;
